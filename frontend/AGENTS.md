...
antes de escrever. Dispara em: React (versão instalada), Vite, Three.js
(render/animação do tabuleiro) e cliente WebSocket. Consulta pontual:
o alvo é a lib, não JS/DOM básico.
