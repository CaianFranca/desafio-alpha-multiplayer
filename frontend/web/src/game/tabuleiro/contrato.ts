...
export type TipoDaPeca =
  ...
  | 'sala_medica'
  | 'portao_de_saida'
  // Monstros (ST-15 / issue #169): entram no wire via TipoDaPecaWire; o
  // espelho visual os recebe pelo mesmo tipo (issue #145 — paridade com o
  // snapshot, sem janela de Manipulação).
  | 'vulto'
  | 'espectro'
