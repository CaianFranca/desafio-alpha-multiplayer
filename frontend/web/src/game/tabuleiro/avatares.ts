 ...
 * `CORES_DOS_PEOES` (ordem = slot). Só o slot 0 (`branco` — Diretor) tem
 * avatar nesta etapa; os demais seguem no `PeaoPlaceholder` (issues #299-301).
 ...
 * entrada"); só o slot 0 (Diretor/branco) está preenchido nesta issue.
 */
