    ...
    >
      ...
      >
        ...
        <button
          ...
          className="pointer-events-auto min-h-[44px] min-w-[44px] rounded border border-amber-500/70 px-3 py-0.5 text-xs font-semibold uppercase tracking-[0.14em] text-amber-400 hover:border-amber-400 hover:text-amber-300 focus-visible:outline-2 focus-visible:outline-amber-500"
        >
          Sair
        </button>
      </div>
        ...
        >
          ...
          <div className="flex gap-2">
            <button
              ...
              onClick={onSair}
              className="min-h-[44px] min-w-[44px] rounded bg-amber-500 px-4 py-1 text-xs font-semibold uppercase tracking-wider text-zinc-900 hover:bg-amber-400 focus-visible:outline-2 focus-visible:outline-amber-500"
            >
              Confirmar
            </button>
            <button
              ...
              className="min-h-[44px] min-w-[44px] rounded border border-zinc-600 px-4 py-1 text-xs uppercase tracking-wider text-zinc-200 hover:border-zinc-400 focus-visible:outline-2 focus-visible:outline-amber-500"
            >
              Cancelar
            </button>
          </div>
