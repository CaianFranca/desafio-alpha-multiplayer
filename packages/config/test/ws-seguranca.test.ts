...
const CASOS_NUMERICOS: ReadonlyArray<{
  ...
  { nome: 'WS_SESSAO_REVALIDACAO_MS teto', chave: 'WS_SESSAO_REVALIDACAO_MS', campo: 'wsSessaoRevalidacaoMs', env: '300000', esperado: 300000, avisa: false },
  ...
  { nome: 'WS_SESSAO_REVALIDACAO_MS acima do teto recusa com warn', chave: 'WS_SESSAO_REVALIDACAO_MS', campo: 'wsSessaoRevalidacaoMs', env: '300001', esperado: 30000, avisa: true },
