...
- **`/repasse`** — escreva um arquivo markdown portátil. Estreito: apenas para um **novo harness**, um **novo diretório**, um **colega**, ou bifurcar uma tarefa lateral **no meio da fase**. O que compra é portabilidade.
