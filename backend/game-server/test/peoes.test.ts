...
// fluxos abaixo assumem a topologia da ordem de composição (reta-1 ao norte,
// reta-2 ao leste da Inicial), então restaura a ordem determinística antes
// dos turnos. O sorteio embaralhado em si é coberto por pecas-especiais.test.ts.
